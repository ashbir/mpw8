...
`define USER_CONFIG_GPIO_5_INIT  `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_6_INIT  `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_7_INIT  `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_8_INIT  `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_9_INIT  `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_10_INIT `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_11_INIT `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_12_INIT `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_13_INIT `GPIO_MODE_USER_STD_NOPULL
...
`define USER_CONFIG_GPIO_25_INIT `GPIO_MODE_USER_STD_NOPULL
`define USER_CONFIG_GPIO_26_INIT `GPIO_MODE_USER_STD_NOPULL
